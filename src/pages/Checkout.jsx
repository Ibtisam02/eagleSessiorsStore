  ...
  const handlePayment = async () => {
    try {
      ...
      if (paymentMethod === "card") {
        ...
        dispatch(stripePaymentCard({ shippingData,orders })).then((res) => {
          console.log(res);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="grid grid-cols-1">
        <button
          type="button"
          className={`py-4 px-1 border rounded-lg flex items-center justify-center gap-2 transition-all
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className="font-semibold">
                          £
                          {(
                            item?.priceAfterDiscount * quantity
                          ).toLocaleString()}
                        </p>
                      </div>
                    );
