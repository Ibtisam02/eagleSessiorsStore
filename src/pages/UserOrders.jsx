...
import { getAllMyOrders } from "../redux/orderSice/getMyAllOrders";
...
const Orders = () => {
  ...
  let {isLoading, orders  } = useSelector((state) => state.getAllMyOrders);

  useEffect(() => {
    dispatch(getAllMyOrders()).then((res) => {
      console.log(res);
    });
  }, []);
  ...
  return (
    <div className="w-full pl-4 pr-4 md:pl-0 md:pr-6 transition-all duration-300 ease-in-out my-4">
      <h2 className="text-center text-xl mt-8 mb-4">My Orders</h2>
                        ...
                        <div className="flex items-center gap-4 w-full md:w-auto">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            {item?.productDetails?.barnd && (
                              <p className="text-sm text-gray-500">
                                Brand: {item?.productDetails?.barnd}
                              </p>
                            )}
                            <p className="text-sm text-gray-500">
                    ...
                    <span className="flex items-center gap-2 text-lg font-medium">
                      {selectedOrder.orderStatus === "canceled" ? (
                        ...
                        <div className="flex gap-x-10">
                          {selectedOrder?.isRated?null:<Link to={`/user/orders/${selectedOrder?._id}`} className="bg-black text-white px-3 py-1 rounded-md">Rate Us</Link>}
